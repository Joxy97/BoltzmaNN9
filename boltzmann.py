...
def cmd_new_project(args):
    ...
    from src.boltzmann.project import create_project
...
def cmd_train(args):
    ...
    from src.boltzmann.pipeline import train_rbm, save_model
    from src.boltzmann.project import create_run, save_run_config, get_run_paths
    from src.boltzmann.run_utils import RunLogger, save_history, save_plots
    ...
    with RunLogger(paths["log"]):
        ...
        from src.boltzmann.data import BMDataset, split_rbm_loaders
        from src.boltzmann.model import RBM
        from src.boltzmann.utils import resolve_device, resolve_pin_memory
...
def cmd_evaluate(args):
    ...
    from src.boltzmann.config import load_config
    from src.boltzmann.pipeline import load_model
    from src.boltzmann.project import get_run_paths, find_latest_run
    from src.boltzmann.run_utils import save_metrics
    ...
    # Import and setup
    from src.boltzmann.data import BMDataset, split_rbm_loaders
    from src.boltzmann.tester import RBMTester
    from src.boltzmann.utils import resolve_device, resolve_pin_memory
...
def cmd_preprocess_raw(args):
    ...
    from src.boltzmann.config import load_config
    from src.boltzmann.preprocessor import DataPreprocessor
...
def cmd_list_runs(args):
    ...
    from src.boltzmann.project import list_runs
